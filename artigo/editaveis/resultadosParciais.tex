...
Este capítulo é destinado aos resultados obtidos através dos experimentos descritos na seção \ref{experimentos}. Observe na figura \ref{fig:graph_result} e na tabela \ref{tab:results_table} abaixo uma comparação entre os modelos de classificação avaliados utilizando as cinco métricas adotadas no projeto.
